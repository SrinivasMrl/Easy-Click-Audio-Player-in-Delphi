...
begin
if (FileListBox1.ItemIndex > 0) or (FileListBox1.ItemIndex = 0) then
    tc_PlayAudioFile;
end;
...
procedure TfrmWhole.BitBtn2Click(Sender: TObject);
  var FDir : String;
begin

  with TOpenDialog.Create(nil) do
    try
      Title := 'Choose Directory by Selecting a file';
      ...
      //        ShowMessage(FileName);
            ...
            DirectoryListBox1.Directory := FDir;
